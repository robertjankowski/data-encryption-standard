IP_TABLE = [
    ...
    62, 54, 46, 28, 30, 22, 14, 6, 64, 56, 48, 40, 32, 24, 16, 8,
...
def _permutation(bits: list, table: list, assert_input_len: int, assert_output_len: int):
    ...
    assert len(output) == assert_output_len
    return output


def initial_permutation(bits: list):
    return _permutation(bits, IP_TABLE, 64, 64)
